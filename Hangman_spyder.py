...
#все работает на бескоченых циклах while True:

#отобразить текущее состояние игры

#вызвать ввод буквы и запомнить ее в правильное место

#проверить условие победы - если победа - вывести поздравление

#проверить условие прогирыша - если проигрыш - вывести последнюю картинку и предложение

#спросить не сыграть ли еще
